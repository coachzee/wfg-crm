...
The WFG CRM system requires several environment variables to function properly. These are managed through the Manus Secrets panel in the Management UI.
...
### MyWFG Integration Credentials

| Variable | Description | How to Obtain |
|----------|-------------|---------------|
| `MYWFG_USERNAME` | MyWFG.com login username | Your MyWFG account username |
| `MYWFG_PASSWORD` | MyWFG.com login password | Your MyWFG account password |
| `MYWFG_EMAIL` | Gmail address for OTP | Gmail account that receives MyWFG OTPs |
...
**Step 4:** Select **Mail** as the app and **Other** as the device (name it "WFG CRM").
...
1. **Password Change** - When you change your MyWFG or Transamerica password
...
|-----------|------------|---------|
| MyWFG Sync | 3:30 PM | Sync agents, cash flow, production data |
| MyWFG Sync | 6:30 PM | Sync agents, cash flow, production data |
...
**Solution:**
1. Verify you can log in manually to the portal (MyWFG or Transamerica)
...
Try logging in manually to the affected portal (MyWFG or Transamerica) using the same credentials.
...
3. **Portal Support** - For MyWFG or Transamerica portal issues, contact their respective support teams
